...
\begin{description}
    ...
    \item[naive approach] a simple classification system with a list of words assigned to each category introduced in Subsection~\ref{naiveApproach}
    ...
    \item[batch cycle] a typical learning cycle over a mini-batch  in a ANN using SLr 
    ...
    \item[community-node] a community considered a node in the detection of communities in the LA or the LeA 
    \item[old-link] links of nodes belonging to the same community-node in the detection of communities in the LA or the LeA
    \item[]
    \item[]
    \item[]
    \item[]
