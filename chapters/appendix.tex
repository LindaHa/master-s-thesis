...
\caption{The statistical values of training on the second sample.  The visualization is portrayed in Figure \ref{CM2Boxplot}.}
...
\caption{The statistical accuracy values of training on the third sample. The portrayal is depicted in Figure \ref{CM3Boxplot}.}
...
\caption{The statistical accuracy values of training on the third sample with pretrained embeddings. The visualization is shown in Figure \ref{CM3EmbeddingsBoxplot}.}
...
\midrule
\rowcolor[HTML]{DAE8E5} 
\textbf{1st sample} & 86.11 & 85.38 & 84.77 & 82.22 & 76.98 & 83.65 \\
\rowcolor[HTML]{EEF9FB} 
\textbf{2nd sample} & 86.69 & 85.76 & 85.01 & 81.25 & 77.78 & 83.81 \\
\rowcolor[HTML]{DAE8E5} 
\textbf{3rd sample} & 88.19 & 87.73 & 86.86 & 85.88 & 81.37 & 86.41 \\
\rowcolor[HTML]{EEF9FB} 
\textbf{3rd sample E} & 89.24 & 88.54 & 86.11 & 84.95 & 72.69 & 85.41 \\
\bottomrule
\end{tabular}
}
