...
\begin {description}
	...
	\item [Page url] addresses (urls) of members belonging into the community. There are up to ten urls visible in the sidebar. All urls are downloadable in a text file. 
